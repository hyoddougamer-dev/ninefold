...
export const RANKS = {
  ...
  linkSent: (email: string) => `An email is on its way to ${email}. Open its link on this device, or type its six-digit code here.`,
  codePrompt: 'The six-digit code from the email',
  codeGo: 'Enter',
