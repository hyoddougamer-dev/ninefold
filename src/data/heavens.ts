...
export const HEAVENS: readonly Heaven[] = [
  { n: 1, han: '真仙', name: 'True Immortal', colour: '#FF5AA6',
  ...
  { n: 6, han: '聖人', name: 'Sage', colour: '#FFCE6B',
  ...
  { n: 7, han: '道祖', name: 'Dao Ancestor', colour: '#FFE08F',
  ...
  { n: 8, han: '混元', name: 'Primordial Unity', colour: '#FFEFC0',
    dragon: { han: '混沌', name: 'Chaos', icon: 'cosmic-egg' },
    gains: 'It has no face. It has never needed one.' },
  { n: 9, han: '鴻蒙', name: 'The Uncarved', colour: '#FFFFFF',
